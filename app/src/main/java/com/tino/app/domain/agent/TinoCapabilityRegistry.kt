...
object TinoCapabilityRegistry {
    val all: Map<TinoCapabilityId, TinoCapabilityDescriptor> = listOf(
        ...
        capability(TinoCapabilityId.REGISTER_STOCK_ENTRY, "product", "quantity", risk = TinoCapabilityRisk.MEDIUM, presentation = TinoPresentationMode.BOTTOM_SHEET, sourceOfTruth = "InventoryRepository"),
